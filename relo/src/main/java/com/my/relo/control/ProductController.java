...
public class ProductController {
	...
	@PostMapping("add")
	public ResponseEntity<?> ProductAdd(HttpSession session, @RequestBody Map<String, Long> sNum) throws AddException {
	...
	@CrossOrigin(allowCredentials = "true", origins = "http://192.168.0.40:5500")
