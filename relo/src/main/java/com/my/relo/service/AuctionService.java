		...
		try {
			...
			for (int i = 0; i < list.size(); i++) {
				...
				if (list.get(i)[10] != null) {
					adDto = AddressDTO.builder().addrNum(Long.parseLong(list.get(i)[10].toString()))
							.addrRecipient(list.get(i)[11].toString()).addrPostNum(list.get(i)[12].toString())
							.addrTel(list.get(i)[13].toString()).addr(list.get(i)[14].toString())
							.addrDetail(list.get(i)[15].toString())
