...
public interface OrdersRepository extends CrudRepository<Orders, Long> {
	 ...
	 * @return List<Orders> 
	 */
	@Query(value="select p.p_num, o.a_num, s.s_name, s.s_brand, sz.size_category_name, a.a_price, o.o_date, od.d_status\r\n"
	 ...
	 * @return Orders
	 */
	@Query(value="select o.a_num, o.o_date, p.p_num , s.s_brand, s.s_name , sz.size_category_name, a.a_price, od.d_status, od.d_tracking_info, od.d_complete_day, ad.addr_num, ad.addr_recipient, ad.addr_tel, ad.addr_post_num, ad.addr, ad.addr_detail\r\n"
	...
	Orders findOrdersByaNum(@Param("aNum") Long aNum);
	 ...
	 * @return List<Orders>
	 */
	@Query(value="select p.p_num, s.m_num, s.s_name, a.m_num as buy_m_num, od.d_complete_day, a.a_price\r\n"
